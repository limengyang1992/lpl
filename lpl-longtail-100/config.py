...
def get_arguments():
    ...
    parser.add_argument('--pgd_nums', default=50, type=int, help='PGD nums')
    parser.add_argument('--alpha', default=0.2, type=float, help='PGD  alpha.')
    parser.add_argument('--split', default=27, type=int, help='PGD split.')
